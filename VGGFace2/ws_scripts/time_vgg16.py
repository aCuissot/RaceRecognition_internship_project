...
x = source_model.get_layer('block5_pool').output  # Ultimo livello della rete originale, senza dropout
...
if not os.path.isdir(dirnm):
    os.mkdir(dirnm)
filepath = os.path.join(dirnm, "vgg.{epoch:02d}-{val_loss:.2f}.hdf5")
