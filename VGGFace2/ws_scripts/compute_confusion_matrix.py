...
adam_with_lr_multipliers = Adam_lr_mult(lr=initial_learning_rate, decay=weight_decay, multipliers=learning_rate_multipliers)
...
if __name__ == '__main__':
    ...
    print("Evluation for %s is starting..." % dirnm)
    
    # Carica i dataset
    val_dataset = '../Faces_labeled/test'
    ckpntlist = ['mobile.05-0.34.hdf5']    
