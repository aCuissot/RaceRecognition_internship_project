...
from VGGFace2.Networks_antonio_like.training_tools import Adam_lr_mult, step_decay_schedule
...
timeComputation = TimeCalc()
callbacks_list = [lr_sched, checkpoint, tbCallBack, timeComputation]
