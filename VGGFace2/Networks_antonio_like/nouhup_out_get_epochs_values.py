...
# for mobilenet blanced
loss = [0.3960, 0.2799, 0.2466, 0.2253, 0.2112, 0.2012, 0.1893, 0.1838, 0.1805, 0.1775, 0.1753, 0.1729, 0.1704, 0.1687, 0.1684]
acc = [0.8553, 0.8991, 0.9115, 0.9190, 0.9242, 0.9278, 0.9321, 0.9341, 0.9353, 0.9364, 0.9371, 0.9380, 0.9391, 0.9394, 0.9396]
val_loss =[0.3405, 0.3462, 0.3495, 0.3673, 0.3374, 0.3580, 0.3563, 0.3482, 0.3535, 0.3546, 0.3527, 0.3643, 0.3576, 0.3689, 0.3670]
val_acc = [0.8907, 0.8909, 0.8950, 0.8935, 0.9000, 0.8957, 0.8996, 0.9004, 0.9006, 0.8998, 0.9003, 0.8995, 0.9009, 0.8998, 0.8986]
