...
train_generator = data_generator_prepr('lfw_train.csv', batch_size)
val_generator = data_generator_prepr('lfw_val.csv', batch_size)

# callbacks
filepath = "mobilemultitask2.best.hdf5"
