...
def data_generator_epsilonerror(csvpath):
    labs = []
    ...
    for row in p:
        ...
        yield (im, gender, age, var)


data = data_generator_epsilonerror('C:/Users/Enrico/Desktop/tirocinio/ALL/csv/chalearnlap2016_nonAll_validation.csv')
...
for i in data:
    img_list = []
    img, gender, age, var = i
    img_list.append(img)
    arrimg = np.array(img_list)
    ...
    if (age < 20):
        epsilon_list_meno20.append(epsilon)
    elif (age < 40):
        epsilon_list_meno40.append(epsilon)
    else:
        epsilon_list_piu40.append(epsilon)

somma = 0
for i in epsilon_list:
    somma += i
epsilon_risultante = somma / len(epsilon_list)
print("Epsilon risultante =  " + str(epsilon_risultante))

somma = 0
for i in epsilon_list_meno20:
    somma += i
epsilon_risultante = somma / len(epsilon_list_meno20)
print("Epsilon risultante meno di 20 anni =  " + str(epsilon_risultante))

somma = 0
for i in epsilon_list_meno40:
    somma += i
epsilon_risultante = somma / len(epsilon_list_meno40)
print("Epsilon risultante meno di 40 anni =  " + str(epsilon_risultante))

somma = 0
for i in epsilon_list_piu40:
    somma += i
epsilon_risultante = somma / len(epsilon_list_piu40)
print("Epsilon risultante più di 40 anni =  " + str(epsilon_risultante))
